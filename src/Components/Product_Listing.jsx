...
import { MousePointerClick, MessageSquare, Zap,MapPin, Activity, Cpu, Music2, Radio, ShoppingBag, Smartphone, 
...
// Countdown Timer Logic
  ...
  const products = [
    { 
      id: 1, 
      title: "Luxury Moon Themed Jewelry | Set With Exaggerated Rings | Earrings, Necklace | Bracelet For Ladies | Bridal Parties And Weddings", 
      price: 27997, 
      oldPrice: 41997,
      rating: 4.3,
      reviews: "4,302",
    ...
    { 
      id: 2, 
      title: "Sophisticated Set | Elegant 6pcs Women's | Fashion Watch Set | with Quartz Movement | Women's style", 
      price: 324797, 
      oldPrice: 397597,
      rating: 4.8,
      reviews: "1,250",
    ...
    { 
      id: 3, 
      title: "Elegant Hat | Zivyes High Tea Hats for Women | Feather Fascinators | for Kentucky Derby Pillbox Hat | Mesh Headband", 
      price: 36195, 
      oldPrice: 45000,
      rating: 4.5,
      reviews: "2,189",
    ...
    { 
      id: 4, 
      title: "Pure Diamond | 2Pcs/Set Girls | Fashion Cubic Zirconia Rings | For Children For Birthday Gifts | For Party Jewelry Daily Decoration", 
      price: 465097, 
      oldPrice: 864997,
      rating: 4.3,
      reviews: "9,902",
    ...
    { 
      id: 5, 
      title: "Fashionable Elegant | Luxury Original Stainless Steel | Rhinestone Decorated Flower | Aesthetics Cuff Bracelet | For Women & Girls | Bridesmaid Gift Valentines | Mom, Mother, Mother's Day, Gift", 
      price: 35797, 
      oldPrice: 857597,
      rating: 4.8,
      reviews: "90,50",
    ...
    { 
      id: 6, 
      title: "Vintage Brass Plated | Coin Hollow Square Pendant | Earrings Ring Necklace | Jewelry Set | Suitable For Women Daily Wear | Festival Gift (Gift Box Not Included)", 
      price: 84795, 
      oldPrice: 756200,
      rating: 4.1,
      reviews: "8,189",
    ...
    { 
      id: 7, 
      title: "Luxury Earring | Pair Of Ladies' | Rhinestone Earrings | Lovely Heart-Shaped Design | For Girls", 
      price: 65297, 
      oldPrice: 98997,
      rating: 3.3,
      reviews: "657,302",
    ...
    { 
      id: 8, 
      title: "Gold Chokar | Women Casual Plain | Luxury 18K Gold-plated Brass Designer Chokar Collection | All Season Daily | Hollow out Metal | Choker Necklaces", 
      price: 44797, 
      oldPrice: 97597,
      rating: 2.8,
      reviews: "765,0",
    ...
    { 
      id: 9, 
      title: "Elegant Heels | For Girls | Stylish red stiletto heels | with intricate silver | crystal straps ❤️", 
      price: 12097, 
      oldPrice: 4500,
      rating: 4.4,
      reviews: "8,099",
    ...
    { 
      id: 10, 
      title: "Hair Clips | Elegant Hair Bands | Stunning New Year's Eve 2026 | Hairstyles | Expert Beauty Advic", 
      price: 8997, 
      oldPrice: 997,
      rating: 4.0,
      reviews: "87,02",
    ...
    { 
      id: 11, 
      title: "Fashion hair brooch | Bridal Blooms 17 | Stunning Floral Bun | Hairstyles for Your Big Day Brooch", 
      price: 12547, 
      oldPrice: 2437,
      rating: 4.9,
      reviews: "62,680",
    ...
    { 
      id: 12, 
      title: "Stylish bangles | Glass Bangles | velvet bangles for women and girls |Part Wear | indian bangles set", 
      price: 1295, 
      oldPrice: 4900,
      rating: 3.5,
      reviews: "546,09",
    ...
    { 
      id: 13, 
      title: "Luxury Foot Wear Rings | Foot Wear Jewellery | Butterfly & Faux Pearl | Charm Anklet Everstylish Wearing For Girls", 
      price: 6547, 
      oldPrice: 23997,
      rating: 4.1,
      reviews: "12,872",
    ...
    { 
      id: 14, 
      title: "Girls Glasses | MR-8 photochromic glasses by eyeecandy | Stylish Oversized Fashion | Glasses With Accents | Lightweight Polycarbonate | Frame & Lenses | Green-Tinted Everyday | Party Wear", 
      price: 87397, 
      oldPrice: 37597,
      rating: 2.8,
      reviews: "91,250",
    ...
    { 
      id: 15, 
      title: "40+ Head Scarf | Head Wrap | Headband Styles For Girls | Bandanna Beauty: 48 Effortless | Chic Hairstyle Ideas", 
      price: 2985, 
      oldPrice: 45000,
      rating: 4.5,
      reviews: "2,189",
      ...
      <AnimatePresence>
        {showNotification && (
          <motion.div
            ...
            className="fixed top-7 right-5 z-[100] bg-[#232f3e]/95 backdrop-blur-md text-white px-7 py-4 rounded-xl shadow-[0_20px_50px_rgba(0,0,0,0.3)] border-l-4 border-[#febd69] flex items-center gap-5"
          >
        ...
        <div className="flex flex-col gap-4">
          <AnimatePresence>
            {filteredProducts.map((item, index) => (
              ...
              >
                {/* Image Section - Perfect Fit Version */}
...
{/* chatbot section and instant messaging start here */}
<div className="fixed bottom-6 right-6 z-[200] flex flex-col items-end gap-4">
  {/**instant messages start here */}
  <AnimatePresence>
    {isChatOpen && (
      <motion.div
...
{/* chatbot SECTION: right bottom end here */}
