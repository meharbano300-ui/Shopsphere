...
// Countdown Timer Logic
  ...
  const products = [
    { 
      id: 20, 
      title: "✧🌹͡ꦿ•*☆ Chanel Perfume | 🥀🦋 •*.𝓡𝓮𝓪𝓵𝓲𝓼𝓽𝓲𝓬 𝓟𝓮𝓻𝓯𝓾𝓶𝓮 ~ ❀..", 
      price: 27997, 
      oldPrice: 41997,
      rating: 4.3,
      reviews: "4,302",
    ...
    { 
      id: 21, 
      title: "✧🌹͡ꦿ•*☆ Dior Perfume | 🥀🦋 •*.𝓡𝓮𝓪𝓵𝓲𝓼𝓽𝓲𝓬 𝓟𝓮𝓻𝓯𝓾𝓶𝓮 ~ ❀..", 
      price: 324797, 
      oldPrice: 397597,
      rating: 4.8,
      reviews: "1,250",
    ...
    { 
      id: 22, 
      title: " ✧🌹͡ꦿ•*☆ Gucci Perfume | 🥀🦋 •*.𝓡𝓮𝓪𝓵𝓲𝓼𝓽𝓲𝓬 𝓟𝓮𝓻𝓯𝓾𝓶𝓮 ~ ❀..", 
      price: 36195, 
      oldPrice: 45000,
      rating: 4.5,
      reviews: "2,189",
    ...
    { 
      id: 23, 
      title: "✧🌹͡ꦿ•*☆ Versace Perfume | 🥀🦋 •*.𝓡𝓮𝓪𝓵𝓲𝓼𝓽𝓲𝓬 𝓟𝓮𝓻𝓯𝓾𝓶𝓮 ~ ❀..", 
      price: 465097, 
      oldPrice: 864997,
      rating: 4.3,
      reviews: "9,902",
    ...
    { 
      id: 24, 
      title: "✧🌹͡ꦿ•*☆ Armani Perfume | 🥀🦋 •*.𝓡𝓮𝓪𝓵𝓲𝓼𝓽𝓲𝓬 𝓟𝓮𝓻𝓯𝓾𝓶𝓮 ~ ❀..", 
      price: 35797, 
      oldPrice: 857597,
      rating: 4.8,
      reviews: "90,50",
    ...
    { 
      id: 25, 
      title: "✧🌹͡ꦿ•*☆ Calvin Klein Perfume | 🥀🦋 •*.𝓡𝓮𝓪𝓵𝓲𝓼𝓽𝓲𝓬 𝓟𝓮𝓻𝓯𝓾𝓶𝓮~ ❀..", 
      price: 84795, 
      oldPrice: 756200,
      rating: 4.1,
      reviews: "8,189",
    ...
    { 
      id: 26, 
      title: "✧🌹͡ꦿ•*☆ Hugo Boss Perfume | 🥀🦋 •*.𝓡𝓮𝓪𝓵𝓲𝓼𝓽𝓲𝓬 𝓟𝓮𝓻𝓯𝓾𝓶𝓮 ~ ❀..", 
      price: 65297, 
      oldPrice: 98997,
      rating: 3.3,
      reviews: "657,302",
    ...
    { 
      id: 27, 
      title: "✧🌹͡ꦿ•*☆ Burberry Perfume | 🥀🦋 •*.𝓡𝓮𝓪𝓵𝓲𝓼𝓽𝓲𝓬 𝓟𝓮𝓻𝓯𝓾𝓶𝓮 ~ ❀..", 
      price: 44797, 
      oldPrice: 97597,
      rating: 2.8,
      reviews: "765,0",
    ...
    { 
      id: 28, 
      title: "✧🌹͡ꦿ•*☆ Yves Saint Laurent (YSL) Perfume | 🥀🦋 •*.𝓡𝓮𝓪𝓵𝓲𝓼𝓽𝓲𝓬 𝓟𝓮𝓻𝓯𝓾𝓶𝓮 ~ ❀..", 
      price: 12097, 
      oldPrice: 4500,
      rating: 4.4,
      reviews: "8,099",
    ...
    { 
      id: 29, 
      title: "✧🌹͡ꦿ•*☆ Tom Ford Perfume | 🥀🦋 •*.𝓡𝓮𝓪𝓵𝓲𝓼𝓽𝓲𝓬 𝓟𝓮𝓻𝓯𝓾𝓶𝓮 ~ ❀..", 
      price: 8997, 
      oldPrice: 997,
      rating: 4.0,
      reviews: "87,02",
    ...
    { 
      id: 30, 
      title: "✧🌹͡ꦿ•*☆ Dolce & Gabbana Perfume | 🥀🦋 •*.𝓡𝓮𝓪𝓵𝓲𝓼𝓽𝓲𝓬 𝓟𝓮𝓻𝓯𝓾𝓶𝓮 ~ ❀..", 
      price: 12547, 
      oldPrice: 2437,
      rating: 4.9,
      reviews: "62,680",
    ...
    { 
      id: 31, 
      title: "✧🌹͡ꦿ•*☆ Paco Rabanne Perfume | 🥀🦋 •*.𝓡𝓮𝓪𝓵𝓲𝓼𝓽𝓲𝓬 𝓟𝓮𝓻𝓯𝓾𝓶𝓮 ~ ❀..", 
      price: 1295, 
      oldPrice: 4900,
      rating: 3.5,
      reviews: "546,09",
    ...
    { 
      id: 32, 
      title: "✧🌹͡ꦿ•*☆ Jean Paul Gaultier Perfume | 🥀🦋 •*.𝓡𝓮𝓪𝓵𝓲𝓼𝓽𝓲𝓬 𝓟𝓮𝓻𝓯𝓾𝓶𝓮 ~ ❀..", 
      price: 6547, 
      oldPrice: 23997,
      rating: 4.1,
      reviews: "12,872",
    ...
    { 
      id: 33, 
      title: "✧🌹͡ꦿ•*☆ Givenchy Perfume | 🥀🦋 •*.𝓡𝓮𝓪𝓵𝓲𝓼𝓽𝓲𝓬 𝓟𝓮𝓻𝓯𝓾𝓶𝓮 ~ ❀..", 
      price: 87397, 
      oldPrice: 37597,
      rating: 2.8,
      reviews: "91,250",
    ...
    { 
      id: 34, 
      title: "✧🌹͡ꦿ•*☆ Prada Perfume | 🥀🦋 •*.𝓡𝓮𝓪𝓵𝓲𝓼𝓽𝓲𝓬 𝓟𝓮𝓻𝓯𝓾𝓶𝓮 ~ ❀..", 
      price: 2985, 
      oldPrice: 45000,
      rating: 4.5,
      reviews: "2,189",
...
<div className="w-full lg:w-[270px] bg-gradient-to-br from-white to-gray-50 p-4 rounded-2xl border-l-4 border-l-[#febd69] shadow-[10px_10px_25px_-15px_rgba(0,0,0,0.1)] flex flex-col justify-between group/price relative overflow-hidden">
  ...
  {/**main body: right side par prices wala section end here */}
   ...
   </main>{/**mani body: all images section end here */}
...
<div className="fixed bottom-6 right-6 z-[200] flex flex-col items-end gap-4">
 ...
 {/** chatbot button styling start here  */}
...
<div className="bg-[#131921] text-white pt-12 pb-6 font-sans">
  <div className="max-w-7xl mx-auto px-8 md:px-16 grid grid-cols-1 md:grid-cols-12 gap-10">
    ...
    {/* Navigation Sections ( 3 Columns for Better Balance) */}
